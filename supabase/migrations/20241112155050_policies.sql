...
AS PERMISSIVE FOR SELECT, INSERT, DELETE
TO authenticated
USING (
  authorize('manage_department_data')
  AND EXISTS (
...
CREATE POLICY "staff_see_own_department" ON public.departments
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('manage_department_data')
...
CREATE POLICY "restrict_course_enrollments" ON public.course_enrollments
...
CREATE POLICY "add_new_semesters" ON public.semesters
AS PERMISSIVE FOR SELECT, INSERT
TO authenticated
USING (
  authorize('manage_courses_for_instructors')
)
-- Staff are only allowed to update or insert in course offerings
CREATE POLICY "staff_manage_course_offerings" ON public.course_offerings
...
CREATE POLICY "advisor_manage_course_enrollments" ON public.course_enrollments
AS PERMISSIVE FOR SELECT, INSERT, DELETE
TO authenticated
USING (
  authorize('manage_student_enrollments')
...
CREATE POLICY "advisor_view_instructors" ON public.course_enrollments
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('perform_what_if_analysis')
...
-- Student can view their own courses from course offerings
...
-- Student can view their own courses from courses
...
CREATE POLICY "view_summary_reports" ON public.departments
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "view_summary_reports" ON public.majors
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('view_summary_reports')
...
CREATE POLICY "view_summary_reports" ON public.students
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('view_summary_reports')
...
CREATE POLICY "view_summary_reports" ON public.instructors
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('view_summary_reports')
...
CREATE POLICY "view_summary_reports" ON public.courses
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('view_summary_reports')
...
CREATE POLICY "view_summary_reports" ON public.semesters
AS PERMISSIVE FOR SELECT
TO authenticated
USING (
  authorize('view_summary_reports')
